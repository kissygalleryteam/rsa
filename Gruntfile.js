        ...
        kmc: {
            ...
            main: {
                files: [
                    ...
                    {
                        src: "<%= pkg.version %>/jsbn.js",
                        dest: "<%= pkg.version %>/build/jsbn.js"
                    },
                    {
                        src: "<%= pkg.version %>/prng4.js",
                        dest: "<%= pkg.version %>/build/prng4.js"
                    },
                    {
                        src: "<%= pkg.version %>/rng.js",
                        dest: "<%= pkg.version %>/build/rng.js"
                    }
                ]
            }
        },
